...
class JCRemoveMemberViewController: CTViewController {
    ...
    private func _init() {
        ...
        tableView.frame = CGRect(x: 0, y: 55, width: view.width, height: view.height - 55)
        ...
        toolView.frame = CGRect(x: 0, y: 0, width: toolView.width, height: 55)
        searchView.frame = CGRect(x: 15, y: 0, width: toolView.width - 30, height: 55)
    ...
    fileprivate func _reloadCollectionView() {
        ...
        case 0:
            ...
            searchView.frame = CGRect(x: 15, y: 0, width: toolView.width - 30, height: 55)
            toolView.frame = CGRect(x: 0, y: 0, width: toolView.width, height: 55)
            tableView.frame = CGRect(x: tableView.x, y: 55, width: tableView.width, height: view.height - 31)
        case 1:
            ...
            toolView.frame = CGRect(x: 0, y: 0, width: toolView.width, height: 55)
            tableView.frame = CGRect(x: tableView.x, y: 55, width: tableView.width, height: view.height - 55)
        case 2:

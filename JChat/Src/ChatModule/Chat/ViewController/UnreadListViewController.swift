...
class UnreadListViewController: CTViewController, CustomNavigation {
    ...
    private lazy var tabedSlideView: DLTabedSlideView = {
        var tabedSlideView = DLTabedSlideView(frame: CGRect(x: 0, y: 0, width: self.view.width, height: self.view.height))

...
//        selectedBackgroundView = view
        ...
        _iconView.snp.makeConstraints { (make) -> Void in
        ...
        _titleLabel.snp.makeConstraints { (make) -> Void in
            make.top.equalTo(_iconView.snp.bottom).offset(4)
            make.centerX.equalTo(contentView)
...
//
//            _SAInputLayoutConstraintMake(_iconView, .width, .equal, nil, .notAnAttribute, 30),
//            _SAInputLayoutConstraintMake(_iconView, .height, .equal, nil, .notAnAttribute, 30),
//

...
class JCSearchResultViewController: CTViewController {
    ...
    private func _init() {
        ...
        view.backgroundColor = UIColor.KTheme.scroll
        automaticallyAdjustsScrollViewInsets = false//不加的话，table会下移
//        navigationController?.automaticallyAdjustsScrollViewInsets = false
    ...
    func reloadSource(){
        ...
        users.removeAll()
        groups.removeAll()
        filteredUsersArray.removeAll()
        filteredGroupsArray.removeAll()

...
class JCSearchFriendViewController: CTViewController {
    ...
    private lazy var searchView: UIView = UIView(frame: CGRect(x: 0, y: self.topOffset, width: self.view.width, height: 55))
    fileprivate lazy var bgView: UIView = UIView(frame: CGRect(x: 0, y: self.topOffset + 50 + 5, width: self.view.width, height: self.view.height - 50 - 5))

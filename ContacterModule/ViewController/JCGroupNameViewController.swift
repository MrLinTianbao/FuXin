...
class JCGroupNameViewController: CTViewController {
...
//        }
    ...
    fileprivate lazy var groupNameTextField: UITextField = UITextField(frame: CGRect(x: 0, y: 0, width: self.view.width, height: 45))
    fileprivate lazy var tipLabel:  UILabel = UILabel(frame: CGRect(x: self.view.width - 15 - 50, y: 18, width: 28, height: 12))
...
//        if !MJManager.isInsideService(showToast: true) {
//            return
//        }
